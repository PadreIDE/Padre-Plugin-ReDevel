...
look to Tools -> Plug-in Manager, select "ReDevel" and click on "Show error messsage" button. After
you fix plugin code use Tools -> Plug-in Tools -> Reload All Plug-ins. Now you should see 
Tools -> ReDevel item again.
...
clear && perl bin/redevel.pl --host=localhost --user="rd" --ver=10 --host_dist_type="linux-64b" --cmd=renew_server_dir
clear && perl bin/redevel.pl --host=localhost --user="rd" --ver=10 --cmd=test_noop_rpc
clear && perl bin/redevel.pl --host=localhost --user="rd" --ver=10 --cmd=test_three_parts_rpc
